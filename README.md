...
2. JSON data.
3. karate (optional, nullable) -- if present, will add request/response to html report. This variable is of type ScenarioBridge and is automatically created when running karate tests.
